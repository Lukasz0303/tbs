...
user1_email="${TEST_PVP_USER1_EMAIL:-test-pvp-user1@test.local}"
user1_password="${TEST_PVP_USER1_PASSWORD:-test123!!}"
user1_username="${TEST_PVP_USER1_USERNAME:-testuser1}"

user2_email="${TEST_PVP_USER2_EMAIL:-test-pvp-user2@test.local}"
user2_password="${TEST_PVP_USER2_PASSWORD:-test123!!}"
user2_username="${TEST_PVP_USER2_USERNAME:-testuser2}"
